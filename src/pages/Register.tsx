      ...
      <div className="auth-container">
        ...
        {step === 'account' && (
          <>
            ...
            {socialNote && <p style={{ color: 'var(--text-muted)', fontSize: 13, textAlign: 'center', margin: '0 0 8px' }}>{socialNote}</p>}

            <div className="social-buttons">
              <button className="btn-social btn-google" onClick={() => setSocialNote('Apple and Google sign-in are coming soon — use email for now.')}>
              ...
              <button className="btn-social btn-apple" onClick={() => setSocialNote('Apple and Google sign-in are coming soon — use email for now.')}>
  ...
  <p className="field-error">Age must be between 18 and 99</p>
              ...
              {step === 'identity' && (
                <div className="wizard-step">
                  ...
                  <label className="field-label">Surgical status (optional)</label>
                  <div className="chip-grid">
                    {SURGERY_OPTIONS.map((o) => (
                      <button
                        key={o}
                        className={`chip ${surgery_status === o ? 'active' : ''}`}
